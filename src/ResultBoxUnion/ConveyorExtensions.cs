...
public static class ConveyorExtensions
{
    ...
    public static async Task<ResultBox<TValue2>> Conveyor<TValue, TValue2>(
        ...
        => current switch
        {
            TValue v => await handleValueFunc(v),
            Exception e => e,
            null => new ResultValueNullException()
        };
    ...
    public static ResultBox<TValueResult> Conveyor<TValue1, TValue2, TValue3, TValueResult>(
        ...
        where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull where TValueResult : notnull
        => current.Conveyor(value => value.Call(handleValueFunc));

    public static async Task<ResultBox<TValueResult>> Conveyor<TValue1, TValue2, TValue3, TValueResult>(
        this ResultBox<ThreeValues<TValue1, TValue2, TValue3>> current,
    ...
    public static ResultBox<TValueResult> Conveyor<TValue1, TValue2, TValue3, TValue4, TValueResult>(
        ...
        where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull
        where TValue4 : notnull where TValueResult : notnull
        => current.Conveyor(value => value.Call(handleValueFunc));

    public static async Task<ResultBox<TValueResult>> Conveyor<TValue1, TValue2, TValue3, TValue4, TValueResult>(
        this ResultBox<FourValues<TValue1, TValue2, TValue3, TValue4>> current,
    ...
    public static ResultBox<TValueResult> Conveyor<TValue1, TValue2, TValue3, TValue4, TValue5, TValueResult>(
        ...
        where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull
        where TValue4 : notnull where TValue5 : notnull where TValueResult : notnull
        => current.Conveyor(value => value.Call(handleValueFunc));

    public static async Task<ResultBox<TValueResult>> Conveyor<TValue1, TValue2, TValue3, TValue4, TValue5, TValueResult>(
        this ResultBox<FiveValues<TValue1, TValue2, TValue3, TValue4, TValue5>> current,
        Func<TValue1, TValue2, TValue3, TValue4, TValue5, Task<ResultBox<TValueResult>>> handleValueFunc)
        where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull
        where TValue4 : notnull where TValue5 : notnull where TValueResult : notnull
        => await current.Conveyor(async value => await value.Call(handleValueFunc));
