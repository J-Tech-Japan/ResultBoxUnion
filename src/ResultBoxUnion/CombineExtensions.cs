...
public static class CombineExtensions
{
    ...
    public static ResultBox<FiveValues<TValue1, TValue2, TValue3, TValue4, TValue5>>
        ...
        where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull
        where TValue4 : notnull where TValue5 : notnull
        => values.Conveyor(value => addingResult.Remap(value.Append));
    ...
    public static Task<ResultBox<ThreeValues<TValue1, TValue2, TValue3>>> Combine<TValue1, TValue2, TValue3>(
        this ResultBox<TwoValues<TValue1, TValue2>> current,
        Func<Task<ResultBox<TValue3>>> combiningFunc)
        where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull
        => current.Combine(_ => combiningFunc())
            .Remap(values => new ThreeValues<TValue1, TValue2, TValue3>(
                values.Value1.Value1, values.Value1.Value2, values.Value2));

    public static Task<ResultBox<FourValues<TValue1, TValue2, TValue3, TValue4>>>
        Combine<TValue1, TValue2, TValue3, TValue4>(
            this ResultBox<ThreeValues<TValue1, TValue2, TValue3>> current,
            Func<Task<ResultBox<TValue4>>> combiningFunc)
        where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull where TValue4 : notnull
        => current.Combine(_ => combiningFunc())
            .Remap(values => new FourValues<TValue1, TValue2, TValue3, TValue4>(
                values.Value1.Value1, values.Value1.Value2, values.Value1.Value3, values.Value2));

    public static Task<ResultBox<FiveValues<TValue1, TValue2, TValue3, TValue4, TValue5>>>
        Combine<TValue1, TValue2, TValue3, TValue4, TValue5>(
            this ResultBox<FourValues<TValue1, TValue2, TValue3, TValue4>> current,
            Func<Task<ResultBox<TValue5>>> combiningFunc)
        where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull
        where TValue4 : notnull where TValue5 : notnull
        => current.Combine(_ => combiningFunc())
            .Remap(values => FiveValues.FromValues(
                values.Value1.Value1, values.Value1.Value2, values.Value1.Value3,
                values.Value1.Value4, values.Value2));
    ...
    public static Task<ResultBox<ThreeValues<TValue1, TValue2, TValue3>>> Combine<TValue1, TValue2, TValue3>(
        this ResultBox<TwoValues<TValue1, TValue2>> current,
        Func<TValue1, TValue2, Task<ResultBox<TValue3>>> combiningFunc)
        where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull
        => current.Combine(value => combiningFunc(value.Value1, value.Value2))
            .Remap(values => ThreeValues.FromValues(values.Value1.Value1, values.Value1.Value2, values.Value2));

    public static Task<ResultBox<FourValues<TValue1, TValue2, TValue3, TValue4>>>
        Combine<TValue1, TValue2, TValue3, TValue4>(
            this ResultBox<ThreeValues<TValue1, TValue2, TValue3>> current,
            Func<TValue1, TValue2, TValue3, Task<ResultBox<TValue4>>> combiningFunc)
        where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull where TValue4 : notnull
        => current.Combine(value => combiningFunc(value.Value1, value.Value2, value.Value3))
            .Remap(values => FourValues.FromValues(
                values.Value1.Value1, values.Value1.Value2, values.Value1.Value3, values.Value2));

    public static Task<ResultBox<FiveValues<TValue1, TValue2, TValue3, TValue4, TValue5>>>
        Combine<TValue1, TValue2, TValue3, TValue4, TValue5>(
            this ResultBox<FourValues<TValue1, TValue2, TValue3, TValue4>> current,
            Func<TValue1, TValue2, TValue3, TValue4, Task<ResultBox<TValue5>>> combiningFunc)
        where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull
        where TValue4 : notnull where TValue5 : notnull
        => current.Combine(value => combiningFunc(value.Value1, value.Value2, value.Value3, value.Value4))
            .Remap(values => FiveValues.FromValues(
                values.Value1.Value1, values.Value1.Value2, values.Value1.Value3,
                values.Value1.Value4, values.Value2));
